...
public class TerrestrialVehicleTest {

    @Test
    public void shouldKeepDistinctWheels() {
        // Given
        ...
        // Then
        assertEquals(8, truck.getNbOfWheels(), "truck should be have 8 wheels");
        assertNotNull(truck.getWheelById(new WheelId("GoodYear pneu", "006")), "should find a truck");
    }
